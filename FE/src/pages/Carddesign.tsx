...
const Carddesign = ({
  ...
  return (
    <div>
      <div className="  w-[300px] boder rounded-lg p-2 transition-all duration-300 cursor-pointer hover:shadow-lg border-[3px] ">
        <div className=" h-[90%] w-[90%] flex  justify-center flex-col">
          ...
          <h1 className="my-3 font-bold text-[16px] whitespace-normal">
            {Text}
          </h1>
